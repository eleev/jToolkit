 ...
 */
public final class EulerCamera implements CameraInterface {
    ...
    public void processKeyboard(float delta) {
        ...
        if (keyUp && keyRight && !keyLeft && !keyDown) {
            moveFromLook(delta * 0.03f, 0, -delta * 0.03f);
        }
        if (keyUp && keyLeft && !keyRight && !keyDown) {
            moveFromLook(-delta * 0.03f, 0, -delta * 0.03f);
        }
        if (keyUp && !keyLeft && !keyRight && !keyDown) {
            moveFromLook(0, 0, -delta * 0.03f);
        }
    ...
    public void processKeyboard(float delta, float speed) {
        ...
        if (keyUp && keyRight && !keyLeft && !keyDown) {
            moveFromLook(speed * delta * 0.03f, 0, -speed * delta * 0.03f);
        }
        if (keyUp && keyLeft && !keyRight && !keyDown) {
            moveFromLook(-speed * delta * 0.03f, 0, -speed * delta * 0.03f);
        }
        if (keyUp && !keyLeft && !keyRight && !keyDown) {
            moveFromLook(0, 0, -speed * delta * 0.03f);
        }
        if (keyDown && keyLeft && !keyRight && !keyUp) {
            moveFromLook(-speed * delta * 0.03f, 0, speed * delta * 0.03f);
        }
        ...
        if (keyLeft && !keyRight && !keyUp && !keyDown) {
            moveFromLook(-speed * delta * 0.03f, 0, 0);
        }
        if (keyRight && !keyLeft && !keyUp && !keyDown) {
            moveFromLook(speed * delta * 0.03f, 0, 0);
        }
    ...
    public void processKeyboard(float delta, float speedX, float speedY, float speedZ) {
        ...
        if (keyUp && keyRight && !keyLeft && !keyDown) {
            moveFromLook(speedX * delta * 0.03f, 0, -speedZ * delta * 0.03f);
        }
        if (keyUp && keyLeft && !keyRight && !keyDown) {
            moveFromLook(-speedX * delta * 0.03f, 0, -speedZ * delta * 0.03f);
        }
        if (keyUp && !keyLeft && !keyRight && !keyDown) {
            moveFromLook(0, 0, -speedZ * delta * 0.03f);
        }
        if (keyDown && keyLeft && !keyRight && !keyUp) {
            moveFromLook(-speedX * delta * 0.03f, 0, speedZ * delta * 0.03f);
        }
        ...
        if (keyLeft && !keyRight && !keyUp && !keyDown) {
            moveFromLook(-speedX * delta * 0.03f, 0, 0);
        }
        if (keyRight && !keyLeft && !keyUp && !keyDown) {
            moveFromLook(speedX * delta * 0.03f, 0, 0);
        }
        if (flyUp && !flyDown) {
            y += speedY * delta * 0.03f;
        }
        if (flyDown && !flyUp) {
            y -= speedY * delta * 0.03f;
        }
